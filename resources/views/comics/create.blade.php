        ...
        <div class="row border border-5 border-primary bg-white p-5">
            ...
            <form method="POST" action="{{route('comics.store')}}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error ('description')is-invalid @enderror"  id="description" name="description" style="height: 100px" value="{{old('description', $comic->description)}}"></textarea>
